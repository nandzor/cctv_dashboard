            ...
            <x-card title="Event Information">
                <dl class="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-6">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ \Carbon\Carbon::parse($eventLog->event_timestamp)->format('M d, Y H:i:s') }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-500">Branch</dt>
                        <dd class="mt-1 text-sm text-gray-900">
                            <a href="{{ route('company-branches.show', $eventLog->branch) }}" class="text-blue-600 hover:text-blue-800">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">
                            <a href="{{ route('device-masters.show', $eventLog->device_id) }}" class="text-blue-600 hover:text-blue-800">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900 font-mono">
                            @if($eventLog->re_id)
                                <a href="{{ route('re-id-masters.show', ['reId' => $eventLog->re_id, 'date' => now()->toDateString()]) }}" class="text-blue-600 hover:text-blue-800">
                    ...
                    @if($eventLog->image_path)
                        <div class="md:col-span-2">
                            ...
                            <dd class="mt-2">
                                <img src="{{ asset('storage/' . $eventLog->image_path) }}" alt="Detection" class="max-w-md rounded-lg border border-gray-200">
                            </dd>
                        </div>
                    @endif
